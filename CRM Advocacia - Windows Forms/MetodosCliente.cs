...
namespace CRM_Advocacia___Windows_Forms
{
    public class MetodosCliente
    {
            ...
            using (var conn = ConexaoBD.ObterConexao())
            {
                ...
                using (var transaction = conn.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        string sqlEndereco = @"INSERT INTO Endereco (id_cliente, cep, estado, cidade, bairro, logradouro, numero, tipo, complemento) 
        ...
        public bool EditarClienteComEndereco(int idCliente,string nome, string cpfCnpj, string tipo, string telefone, string email, string descricao, string data,
        string cep, string estado, string cidade, string bairro, string logradouro, string numero, string tiporesiden, string compl,
        bool ativo)
        {
            using (var conn = ConexaoBD.ObterConexao())
